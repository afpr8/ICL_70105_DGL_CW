...
- Our final chosen hyperparameters are in the dataclass `NeuroSRGANArgs` (instantiated on line 25 of the `train_NeuroSRGAN.py`), here you can reduce epochs to save time running the whole script.
